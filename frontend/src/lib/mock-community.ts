...
export const MOCK_CTF_EVENTS: CtfEvent[] = [
  { id: "c1", slug: "winter-clash-2026", name: "Winter Clash 2026", description: "Our flagship seasonal jeopardy CTF. 48 hours, 40 challenges, glory on the line.", format: "jeopardy", state: "live", startsAt: new Date(Date.now() - 3600_000 * 6).toISOString(), endsAt: new Date(Date.now() + 3600_000 * 42).toISOString(), participantCount: 8420, entryFeeCents: 0, currency: "USD", selfServeRegistration: true, scoreboardVisibility: "public", isPaused: false, pauseStartsAt: null, pauseEndsAt: null, pauseReason: null, teamCount: 2110, challengeCount: 40, prizePool: "$15,000", bannerColor: "#7C3AED", bannerImageUrl: null, status: "live", teamPlay: false, soloPlay: true, maxTeamSize: null, isRegistered: true },
  { id: "c2", slug: "weekly-sprint-w22", name: "Weekly Sprint #22", description: "A quick 6-hour jeopardy sprint. Perfect for a Saturday afternoon.", format: "jeopardy", state: "upcoming", startsAt: new Date(Date.now() + 3600_000 * 30).toISOString(), endsAt: new Date(Date.now() + 3600_000 * 36).toISOString(), participantCount: 1240, entryFeeCents: 0, currency: "USD", selfServeRegistration: true, scoreboardVisibility: "public", isPaused: false, pauseStartsAt: null, pauseEndsAt: null, pauseReason: null, teamCount: 980, challengeCount: 18, prizePool: null, bannerColor: "#2563EB", bannerImageUrl: null, status: "live", teamPlay: false, soloPlay: true, maxTeamSize: null, isRegistered: false },
  { id: "c3", slug: "redteam-royale", name: "RedTeam Royale", description: "Attack-defense warfare. Patch your services while breaking everyone else's.", format: "attack_defense", state: "upcoming", startsAt: new Date(Date.now() + 3600_000 * 24 * 5).toISOString(), endsAt: new Date(Date.now() + 3600_000 * 24 * 5 + 3600_000 * 8).toISOString(), participantCount: 640, entryFeeCents: 0, currency: "USD", selfServeRegistration: true, scoreboardVisibility: "public", isPaused: false, pauseStartsAt: null, pauseEndsAt: null, pauseReason: null, teamCount: 80, challengeCount: 12, prizePool: "$8,000", bannerColor: "#6D28D9", bannerImageUrl: null, status: "live", teamPlay: false, soloPlay: true, maxTeamSize: null, isRegistered: false },
  { id: "c4", slug: "autumn-open-2025", name: "Autumn Open 2025", description: "Last season's open jeopardy event. Now available for practice.", format: "jeopardy", state: "ended", startsAt: "2025-10-12T12:00:00Z", endsAt: "2025-10-14T12:00:00Z", participantCount: 11200, entryFeeCents: 0, currency: "USD", selfServeRegistration: true, scoreboardVisibility: "public", isPaused: false, pauseStartsAt: null, pauseEndsAt: null, pauseReason: null, teamCount: 3400, challengeCount: 45, prizePool: "$20,000", bannerColor: "#1D4ED8", bannerImageUrl: null, status: "live", teamPlay: false, soloPlay: true, maxTeamSize: null, isRegistered: false },
];
