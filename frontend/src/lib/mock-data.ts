...
export const MOCK_MACHINES: Machine[] = [
  { id: "m1", slug: "sentinel", name: "Sentinel", os: "linux", difficulty: "easy", points: 20, rating: 4.6, ratingCount: 1820, userOwns: 9240, rootOwns: 7110, isActive: true, isFree: true, releasedAt: "2026-05-10", retiresAt: null, tags: ["web", "sqli"], makers: [MAKERS[0]!], thumbnailColor: "#7C3AED" },
  { id: "m2", slug: "irongate", name: "IronGate", os: "windows", difficulty: "medium", points: 30, rating: 4.4, ratingCount: 1330, userOwns: 5120, rootOwns: 3980, isActive: true, isFree: false, releasedAt: "2026-05-03", retiresAt: null, tags: ["ad", "smb"], makers: [MAKERS[1]!], thumbnailColor: "#2563EB" },
  { id: "m3", slug: "obsidian", name: "Obsidian", os: "linux", difficulty: "hard", points: 40, rating: 4.8, ratingCount: 940, userOwns: 2010, rootOwns: 1240, isActive: true, isFree: false, releasedAt: "2026-04-26", retiresAt: null, tags: ["pwn", "kernel"], makers: [MAKERS[2]!], thumbnailColor: "#6D28D9" },
  { id: "m4", slug: "cipher", name: "Cipher", os: "linux", difficulty: "medium", points: 30, rating: 4.2, ratingCount: 1110, userOwns: 4300, rootOwns: 3220, isActive: true, isFree: false, releasedAt: "2026-04-19", retiresAt: null, tags: ["crypto", "web"], makers: [MAKERS[0]!], thumbnailColor: "#1D4ED8" },
  { id: "m5", slug: "warden", name: "Warden", os: "windows", difficulty: "insane", points: 50, rating: 4.9, ratingCount: 610, userOwns: 720, rootOwns: 380, isActive: true, isFree: false, releasedAt: "2026-04-12", retiresAt: null, tags: ["ad", "pwn"], makers: [MAKERS[1]!], thumbnailColor: "#3B82F6" },
  { id: "m6", slug: "harbor", name: "Harbor", os: "linux", difficulty: "easy", points: 20, rating: 4.1, ratingCount: 2210, userOwns: 11200, rootOwns: 9010, isActive: true, isFree: true, releasedAt: "2026-04-05", retiresAt: null, tags: ["docker", "web"], makers: [MAKERS[2]!], thumbnailColor: "#8B5CF6" },
  { id: "m7", slug: "relay", name: "Relay", os: "linux", difficulty: "medium", points: 30, rating: 4.5, ratingCount: 980, userOwns: 3600, rootOwns: 2700, isActive: false, isFree: true, releasedAt: "2026-02-01", retiresAt: "2026-04-01", tags: ["network"], makers: [MAKERS[0]!], thumbnailColor: "#7C3AED" },
  { id: "m8", slug: "phantom", name: "Phantom", os: "windows", difficulty: "hard", points: 40, rating: 4.7, ratingCount: 720, userOwns: 1500, rootOwns: 980, isActive: false, isFree: true, releasedAt: "2026-01-15", retiresAt: "2026-03-15", tags: ["ad", "evasion"], makers: [MAKERS[1]!], thumbnailColor: "#2563EB" },
];
...
const LB_SEED: Omit<LeaderRow, "rank">[] = [
  { userId: "u1", username: "zer0Kelvin", avatarUrl: null, country: "de", tier: "elite_operator", points: 142850, ownedMachines: 538, solvedChallenges: 1240, change: 0 },
  { userId: "u2", username: "sh4dowByte", avatarUrl: null, country: "pk", tier: "elite_operator", points: 138200, ownedMachines: 512, solvedChallenges: 1190, change: 1 },
  { userId: "u3", username: "nullptr_", avatarUrl: null, country: "us", tier: "guru", points: 131940, ownedMachines: 498, solvedChallenges: 1110, change: -1 },
  { userId: "u4", username: "kr4ken", avatarUrl: null, country: "jp", tier: "guru", points: 128500, ownedMachines: 470, solvedChallenges: 1080, change: 2 },
  { userId: "u5", username: "h3xqueen", avatarUrl: null, country: "br", tier: "pro_hacker", points: 121300, ownedMachines: 445, solvedChallenges: 1020, change: 0 },
  { userId: "u6", username: "ghostshell", avatarUrl: null, country: "in", tier: "pro_hacker", points: 117600, ownedMachines: 432, solvedChallenges: 990, change: 3 },
  { userId: "u7", username: "bin4ryFox", avatarUrl: null, country: "gb", tier: "elite_hacker", points: 109450, ownedMachines: 410, solvedChallenges: 940, change: -2 },
  { userId: "u8", username: "seg.fault", avatarUrl: null, country: "fr", tier: "elite_hacker", points: 104200, ownedMachines: 398, solvedChallenges: 910, change: 1 },
  { userId: "u9", username: "stackSmasher", avatarUrl: null, country: "nl", tier: "elite_hacker", points: 98700, ownedMachines: 380, solvedChallenges: 870, change: 0 },
  { userId: "u10", username: "rootveil", avatarUrl: null, country: "ca", tier: "pro_hacker", points: 94100, ownedMachines: 366, solvedChallenges: 840, change: 4 },
  { userId: "u11", username: "0xAurora", avatarUrl: null, country: "au", tier: "pro_hacker", points: 90500, ownedMachines: 352, solvedChallenges: 810, change: -1 },
  { userId: "u12", username: "vellichor", avatarUrl: null, country: "se", tier: "pro_hacker", points: 87200, ownedMachines: 340, solvedChallenges: 780, change: 2 },
];
