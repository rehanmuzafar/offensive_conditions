// Package auth provides JWT validation for the orchestrator.
//
// The auth service signs JWTs with RSA. The orchestrator caches the public key
// at startup and verifies tokens locally — no gRPC roundtrip on the hot path.
package auth
...
// Validator verifies JWTs using a cached public key.
...
// Validate parses, verifies signature/expiry/issuer/audience.
